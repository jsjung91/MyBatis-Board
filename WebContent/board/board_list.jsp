...
<c:forEach var="vo" items="${ list }">
			<tr>
				...
				<a href="view.do?idx=${ vo.idx }&page=${ (param.page==null || param.page=='' ) ? 1 : param.page }&search=${ param.search}&search_text=${ param.search_text}"
				 style="text-decoration:none; text-decoration:none; color:red;" class="num">
					${ vo.subject }
				</a></td>
				<td class="td_b_1"><img src="../img/td_bg_02.gif"></td>
...
<!-- 게시물이 없는경우 -->
	...
	<tr>
		<td>
		<!-- 등록 버튼 이미지 -->
		<img src="../img/btn_reg.gif" onClick="JavaScript:location.href='insert_form.do'" style="cursor:pointer">
		</td>
	</tr>
</table>
</td>
