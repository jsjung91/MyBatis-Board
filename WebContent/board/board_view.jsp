...
<script type="text/javascript">
	...
	function reply() {
		...
		location.href = "reply_form.do?idx=${vo.idx}&page=${ param.page }&search=${ param.search}&search_text=${param.search_text}";
...
<BODY>
	...
	<form name="f" method="post">
		<table width="690" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td width="120" height="30" class="td_d_4">O S </td>
				<td class="td_d_2">${ vo.chk_info }</td>
			</tr>
			<tr>
		...
		<table width="690" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				onClick="javaScript:location.href='list.do?page=${ param.page }&search=${ param.search}&search_text=${ param.search_text}'"
					style="cursor: hand"> <!-- 메인글에 대해서만 답변글를 달아라..  --> 
					...
					<img src='../img/btn_delete.gif' onClick='del()' style='cursor: hand'></td>
			</tr>
		</table>
	</form>
